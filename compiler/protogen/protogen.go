...
import (
	...
	"github.com/yangjerry110/protoc-gen-go/types/pluginpb"
)
...
func (opts Options) New(req *pluginpb.CodeGeneratorRequest) (*Plugin, error) {
	...
	//
	//     option go_package = "github.com/yangjerry110/protoc-gen-go/types/known/anypb";
	//
...
// For example: "github.com/yangjerry110/protoc-gen-go/compiler/protogen"
