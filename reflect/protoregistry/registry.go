...
//
//	go build -ldflags "-X github.com/yangjerry110/protoc-gen-go/reflect/protoregistry.conflictPolicy=warn"
//
...
func (r *Files) checkGenProtoConflict(path string) {
	...
	currPath := "github.com/yangjerry110/protoc-gen-go/types/known/" + pkgName
	panic(fmt.Sprintf(""+
